...
- [x] **BAND-02**: User can create a new band
- [x] **BAND-03**: User can view band detail (name, members, invite code)
- [x] **BAND-04**: User can update a band's name
- [x] **BAND-05**: Band owner can delete a band
- [x] **BAND-06**: User can join a band via invite code
...
| BAND-02 | Phase 2 | Complete |
| BAND-03 | Phase 2 | Complete |
| BAND-04 | Phase 2 | Complete |
| BAND-05 | Phase 2 | Complete |
| BAND-06 | Phase 2 | Complete |
