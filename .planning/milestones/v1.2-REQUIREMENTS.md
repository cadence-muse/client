# Requirements Archive: v1.2 i18n and Duration Input
...
- [x] **I18N-01**: User can switch app language between English and Russian from Profile settings; English is the default
- [x] **I18N-02**: Language switch applies live across the whole app with no restart required
- [x] **I18N-03**: Selected language persists locally on-device across app restarts (no API/account sync)
...
|-------------|-------|--------|
| I18N-01 | Phase 12: Locale + i18n Infrastructure | Complete |
| I18N-02 | Phase 12: Locale + i18n Infrastructure | Complete |
| I18N-03 | Phase 12: Locale + i18n Infrastructure | Complete |
